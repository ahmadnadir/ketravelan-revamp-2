        ...
        <div className="space-y-6 text-center lg:text-left">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-md mx-auto lg:mx-0 leading-relaxed">
              Travel with friends or new travel buddies. Ketravelan tracks shared expenses and automatically calculates the net settlement for everyone so you can skip the math, not the experience.
            </p>
          </div>
