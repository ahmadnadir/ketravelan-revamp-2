/*
  # Hotfix: ensure chat summaries RPC exists and is visible to PostgREST

  Some environments returned 404 for /rest/v1/rpc/get_chat_conversation_summaries
  when the function migration was missing or PostgREST schema cache was stale.
*/
