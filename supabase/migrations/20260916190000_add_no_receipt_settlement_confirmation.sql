CREATE OR REPLACE FUNCTION public.confirm_settlement_payment_without_receipt(
...
REVOKE ALL ON FUNCTION public.confirm_settlement_payment_without_receipt(uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.confirm_settlement_payment_without_receipt(uuid) TO authenticated;